...
<head>
    ...
    <style>
        #imag::before{
            background: linear-gradient(135deg, rgb(241, 39, 17) 0%, rgb(245, 175, 25) 100%);
        }
        
        .blo:nth-child(2) ul li{
            background: linear-gradient(0deg, rgb(241, 39, 17) 0%, rgb(245, 175, 25) 100%);
    ...
    <div class="sideBar">
        ...
        <div class="blo">
            ...
            <ul>
                ...
                <a href="#"><li>Manage Suppliers</li></a>
                <a href="#"><li>Manage Third Parties</li></a>
                <a href="#"><li>Manage Resources</li></a>
                <a href="#"><li>Manage Finance</li></a>
