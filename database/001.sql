...
CREATE TABLE Invoices (
    Invoice_ID VARCHAR(10) PRIMARY KEY NOT NULL CHECK (Invoice_ID LIKE 'IN%') ,
...
CREATE TABLE Payments (
    Payment_ID VARCHAR(10) PRIMARY KEY NOT NULL CHECK (Payment_ID LIKE 'PY%'),
    Invoice_ID VARCHAR(10),
    Pay_Amount DECIMAL(10, 2),
    Pay_Date DATE,
    Pay_Method VARCHAR(75),
    Patient_ID VARCHAR(10),
